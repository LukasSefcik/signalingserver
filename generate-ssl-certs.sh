...
openssl req -new -key ./config/sslcerts/key.pem -out ./config/sslcerts/csr.pem -subj "/C=SK/ST=Slovakia/L=Martin/O=PBO s.r.o./CN=https://signalingserver-eytp.onrender.com"
